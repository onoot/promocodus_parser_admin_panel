...
//const url = `https://promokodus.com/campaigns/${category}?couponId=${dataId}&display_code=1`
...
export class parseCode {
    ...
    public async parse(): Promise<string> {
        ...
        try {
            ...
            const cardData = await page.$eval('.cm-code-wrap input', (input) => {
            ...
            console.error('Ошибка в модуле "getCode"');
            return null;
        } finally {
            await browser.close();
        }
